...
export async function processFile(translationFile: string, fileToTranslate: string, saveAs: string | null = null, rowOffSet: number = 1) {
	/*
	 * translationFile - file with translated strings to adapt
	 * fileToTranslate - Template file generated by running admin/translations.ts => writeCsvTemplateToFile()
	 * saveAs - optional output file (if not provided fileToTranslate(without ORIGINAL-EXT)-translated.ORIGINAL-EXT would be used
	 */
