...
export async function validateJWT(jwt: string): Promise<SignInContext> {
...
export async function validateWhitelist(
	appUserId: string, appId: string, apiKey: string): Promise<SignInContext> {
...
export async function validateApiKey(apiKey: string, appId: string) {
